...
public class FlutterJNI {
   ...
   * paint.
   *
   * <p>See {@link SurfaceHolder.Callback#surfaceCreated(SurfaceHolder)} for an example
   ...
   * SurfaceHolder#getSurface()} to {@link android.media.ImageReader#getSurface()} when
   ...
   *
   * <p>See {@link SurfaceHolder.Callback#surfaceChanged(SurfaceHolder, int, int, int)}
   ...
   *
   * <p>See {@link SurfaceHolder.Callback#surfaceDestroyed(SurfaceHolder)} for an
