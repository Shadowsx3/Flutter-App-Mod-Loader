...
/**
 * Static singleton cache that holds {@link FlutterEngine} instances
 * identified by {@code String}s.
 *
 * <p>The ID of a given {@link FlutterEngine} can be whatever {@code
 * String} is desired.
 *
 * <p>{@code FlutterEngineCache} is useful for storing pre-warmed {@link
 * FlutterEngine} instances. {@link
 ...
 * internally when instructed to use a cached {@link FlutterEngine}
...
public class FlutterEngineCache {
  ...
  /**
   * Returns {@code true} if a {@link FlutterEngine} in this cache is
  ...
  /**
   * Returns the {@link FlutterEngine} in this cache that is associated
   * with the given {@code engineId}, or {@code null} is no such {@link
   * FlutterEngine} exists.
   */
  @Nullable
  ...
  /**
   * Places the given {@link FlutterEngine} in this cache and associates
   * it with the given {@code engineId}.
   *
   * <p>If a {@link FlutterEngine} already exists in this cache for the
   * given {@code engineId}, that {@link FlutterEngine} is removed from
   * this cache.
   */
  ...
  /**
   * Removes any {@link FlutterEngine} that is currently in the cache
  ...
  /**
   * Removes all {@link FlutterEngine}'s that are currently in the
   * cache.
   */
  public void clear() {
    cachedEngines.clear();
