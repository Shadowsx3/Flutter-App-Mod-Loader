...
public class FlutterRenderer implements TextureRegistry {
  ...
  @NonNull
  private final Set<WeakReference<OnTrimMemoryListener>> onTrimMemoryListeners =
      new HashSet<>();
  ...
  final class SurfaceTextureRegistryEntry
      implements SurfaceTextureEntry, OnTrimMemoryListener {
  ...
  final class ImageTextureRegistryEntry
      implements ImageTextureEntry, ImageConsumer {
   ...
   * android.view.SurfaceHolder#getSurface()} to {@link ImageReader#getSurface()} when
