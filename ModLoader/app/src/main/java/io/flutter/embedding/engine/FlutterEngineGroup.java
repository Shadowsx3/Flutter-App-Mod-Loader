...
/**
 * Represents a collection of {@link FlutterEngine}s who share resources
 * to allow them to be created faster and with less memory than calling the {@link
 * FlutterEngine}'s constructor multiple times.
 *
 * <p>When creating or recreating the first {@link FlutterEngine} in the
 * FlutterEngineGroup, the behavior is the same as creating a {@link
 * FlutterEngine} via its constructor. When subsequent {@link
 * FlutterEngine}s are created, resources from an existing living {@link
 * FlutterEngine} is re-used.
 *
 * <p>The shared resources are kept until the last surviving {@link
 * FlutterEngine} is destroyed.
 *
 * <p>Deleting a FlutterEngineGroup doesn't invalidate its existing {@link
 * FlutterEngine}s, but it eliminates the possibility to create more
...
public class FlutterEngineGroup {
   ...
   * existing engines were {@link FlutterEngine#destroy()}ed, the next
  ...
  public static class Options {
     ...
     *     registered during the execution of {@link FlutterEngine}'s
     *     constructor.
     */
