 ...
 * FlutterEngine}. To use a cached {@link
 * FlutterEngine}, ensure that the {@link
 * FlutterEngine} is stored in {@link
 ...
 * FlutterEngine}'s ID.
 *
 * <p>It is generally recommended to use a cached {@link FlutterEngine}
 * to avoid a momentary delay when initializing a new {@link
 * FlutterEngine}. The two exceptions to using a cached {@link
 * FlutterEngine} are:
 *
 * <ul>
 *   <li>When {@code FlutterFragment} is in the first {@code Activity} displayed by the app, because
 *       pre-warming a {@link FlutterEngine} would have no impact in
 *       this situation.
 ...
 * FlutterView}. Using a {@link
 * FlutterView} requires forwarding some calls from an {@code
...
public class FlutterFragment extends Fragment
  ...
  /**
   * {@link RenderMode} to be used for the {@link FlutterView} in this
   * {@code FlutterFragment}
   */
  protected static final String ARG_FLUTTERVIEW_RENDER_MODE = "flutterview_render_mode";
  /**
   * {@link TransparencyMode} to be used for the {@link FlutterView} in
  ...
  /**
   * The ID of a {@link FlutterEngine} cached in {@link
   ...
   * the {@link FlutterEngine} should outlive the {@code
   * FlutterFragment}.
   */
   ...
   * FlutterEngine} within the {@code FlutterFragment} and uses the
   * following settings:
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>To use a new {@link FlutterEngine} with different settings, use
   * {@link #withNewEngine()}.
   *
   * <p>To use a cached {@link FlutterEngine} instead of creating a new
  ...
  public static class NewEngineFragmentBuilder {
     ...
     * FlutterView}, or force an {@link TransparencyMode#opaque}
     * background.
     *
     ...
     * that are attached to the {@link FlutterEngine}. If {@code
     * shouldAttachEngineToActivity} is true then this {@code FlutterFragment} will connect its
     * {@link FlutterEngine} to the surrounding {@code Activity}, along
     ...
     * Activity#onNewIntent(Intent)}. If {@code shouldAttachEngineToActivity} is false,
     * then this {@code FlutterFragment} will not automatically manage the connection between its
     * {@link FlutterEngine} and the surrounding {@code Activity}. The
     * {@code Activity} will need to be manually connected to this {@code FlutterFragment}'s {@link
     * FlutterEngine} by the app developer. See {@link
     ...
     * FlutterEngine} and the surrounding {@code Activity}.
     *
     * <p>Another reason that a developer might choose to manually manage the relationship between
     * the {@code Activity} and {@link FlutterEngine} is if the
     * developer wants to prevent, or explicitly control when the {@link
     * FlutterEngine}'s plugins have access to the surrounding {@code
     ...
     * {@link FlutterEngine} to have access to the {@code Activity},
   ...
   * FlutterFragment} if a cached {@link FlutterEngine} is requested but
   * does not exist in the cache.
   *
   * <p>To create a {@code FlutterFragment} that uses a new {@link
   * FlutterEngine}, use {@link #createDefault()} or {@link
   * #withNewEngine()}.
   */
  @NonNull
   ...
   * FlutterEngine} with {@code arguments} that correspond to the values
  ...
  public static class CachedEngineFragmentBuilder {
    ...
    /**
     * Pass {@code true} to destroy the cached {@link FlutterEngine}
     * when this {@code FlutterFragment} is destroyed, or {@code false} for the cached {@link
     * FlutterEngine} to outlive this {@code FlutterFragment}.
     */
    @NonNull
   ...
   * Fragment}.
   *
   * <p>See {@link Activity#onNewIntent(Intent)}
   *
   * <p>
   *
   ...
   *
   * <p>See {@link Activity#onUserLeaveHint()}
   */
  @ActivityCallThrough
   ...
   * want to use a cached {@link FlutterEngine}.
   */
  @Nullable
  @Override
  ...
  /**
   * Returns false if the {@link FlutterEngine} within this {@code
   * FlutterFragment} should outlive the {@code FlutterFragment}, itself.
   *
   * <p>Defaults to true if no custom {@link FlutterEngine is provided},
  ...
  /**
   * Returns the desired {@link RenderMode} for the {@link FlutterView}
   ...
   * FlutterView} displayed in this {@code FlutterFragment}.
   *
  ...
  /**
   * Hook for subclasses to return a {@link FlutterEngine} with whatever
   ...
   * FlutterEngineProvider}. If this method is overridden, the
   * surrounding {@code Activity} will no longer be given an opportunity to provide a {@link
   * FlutterEngine}, unless the subclass explicitly implements that
   * behavior.
   *
   * <p>Consider returning a cached {@link FlutterEngine} instance from
   * this method to avoid the typical warm-up time that a new {@link
   * FlutterEngine} instance requires.
   *
   * <p>If null is returned then a new default {@link FlutterEngine}
   ...
   * FlutterEngine} that is owned by this {@code FlutterActivity}.
   */
  @Nullable
   ...
   * {@link FlutterEngine} has been attached to the owning {@code
   ...
   * {@link FlutterEngineConfigurator}. Subclasses can override this
