...
/**
 * Provides a {@link FlutterEngine} instance to be used by a {@code
 * FlutterActivity} or {@code FlutterFragment}.
 *
 * <p>{@link FlutterEngine} instances require significant time to warm
 * up. Therefore, a developer might choose to hold onto an existing {@link
 * FlutterEngine} and connect it to various {@link FlutterActivity}s
 * and/or {@code FlutterFragment}s. This interface facilitates providing a cached, pre-warmed {@link
 * FlutterEngine}.
 */
public interface FlutterEngineProvider {
  /**
   * Returns the {@link FlutterEngine} that should be used by a child
   * {@code FlutterFragment}.
   *
   * <p>This method may return a new {@link FlutterEngine}, an existing,
