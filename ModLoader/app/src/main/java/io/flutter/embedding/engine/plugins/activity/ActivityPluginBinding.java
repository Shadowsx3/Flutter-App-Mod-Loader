 ...
 * Activity} and the {@link Activity}'s lifecycle methods.
 *
...
public interface ActivityPluginBinding {
  ...
  /**
   * Returns the {@link Activity} that is currently attached to the {@link
  ...
  interface OnSaveInstanceStateListener {
     ...
     * Activity#onCreate(Bundle)} or associated {@code Fragment} executes {@code
