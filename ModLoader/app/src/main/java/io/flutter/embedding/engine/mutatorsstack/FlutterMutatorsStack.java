 ...
 * series mutations. See {@link FlutterMutator} for informations on Mutators.
 */
@Keep
public class FlutterMutatorsStack {
  /**
   * The type of a Mutator See {@link FlutterMutator} for informations on
   * Mutators.
   */
   ...
   * FlutterMutator} for informations on Mutators.
   */
  ...
  /**
   * Push a transform {@link FlutterMutator} to the stack.
   *
  ...
  /** Push a clipRect {@link FlutterMutator} to the stack. */
  ...
  /**
   * Push a clipRRect {@link FlutterMutator} to the stack.
   *
