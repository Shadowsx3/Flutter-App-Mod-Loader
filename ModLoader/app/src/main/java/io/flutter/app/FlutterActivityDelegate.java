...
/**
 * Deprecated class that performs the actual work of tying Android {@link Activity}
 ...
 * FlutterView.Provider} and forward those methods to this class as well.
 *
 * @deprecated {@link io.flutter.embedding.android.FlutterActivity} is the new API that now replaces
 *     this class and {@link FlutterActivity}. See
