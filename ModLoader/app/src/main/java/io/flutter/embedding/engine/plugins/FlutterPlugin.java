 ...
 * instance of {@link FlutterEngine}. To do this, obtain a {@link
 ...
 * FlutterEngine} will invoke {@link
 * #onAttachedToEngine(FlutterPluginBinding)} on the given {@code FlutterPlugin}. If the {@code
 * FlutterPlugin} is removed from the {@link FlutterEngine} via {@link
 * PluginRegistry#remove(Class)}, or if the {@link FlutterEngine} is
 ...
 * FlutterEngine}, the plugin's code is permitted to access and invoke
 * methods on resources within the {@link FlutterPluginBinding} that the {@link
 * FlutterEngine} gave to the {@code FlutterPlugin} in {@link
