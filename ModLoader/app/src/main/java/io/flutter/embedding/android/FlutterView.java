 ...
 *
 * <ol>
 *   <li>{@link RenderMode#surface}, which paints a Flutter UI to a
 ...
 *       render mode.
 *   <li>{@link RenderMode#texture}, which paints a Flutter UI to a
 *       {@link android.graphics.SurfaceTexture}. This mode is not as performant as {@link
 *       RenderMode#surface}, but a {@code FlutterView} in this mode
...
public class FlutterView extends FrameLayout
  ...
  /**
   * Returns true if an attached {@link FlutterEngine} has rendered at
   * least 1 frame to this {@code FlutterView}.
   *
   * <p>Returns false if no {@link FlutterEngine} is attached.
   *
   * <p>This flag is specific to a given {@link FlutterEngine}. The
  ...
  /**
   * Refresh {@link androidx.window.layout.WindowInfoTracker} and {@link DisplayCutout}
   ...
   * this {@code FlutterView} to the given {@link FlutterEngine}, e.g.,
   ...
   * previously-attached {@link FlutterEngine}. This includes touch
  ...
  /**
   * Returns the {@link FlutterEngine} to which this {@code FlutterView}
  ...
  /**
   * Listener that is notified when a {@link FlutterEngine} is attached
  ...
  public interface FlutterEngineAttachmentListener {
    ...
    /**
     * A previously attached {@link FlutterEngine} has been detached
