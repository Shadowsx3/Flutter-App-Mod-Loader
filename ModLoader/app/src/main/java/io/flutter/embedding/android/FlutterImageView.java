...
/**
 * Paints a Flutter UI provided by an {@link ImageReader} onto a {@link
 * Canvas}.
 *
 ...
 *
 * <p>This {@code View} takes an {@link ImageReader} that provides the Flutter UI in
 * an {@link Image} and renders it to the {@link Canvas} in {@code
 * onDraw}.
 */
