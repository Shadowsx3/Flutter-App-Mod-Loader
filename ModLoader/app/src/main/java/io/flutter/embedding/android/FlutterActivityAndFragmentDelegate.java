...
/* package */ class FlutterActivityAndFragmentDelegate implements ExclusiveAppComponent<Activity> {
   ...
   * FlutterEngine}. The behavior that destroys a {@link
   * FlutterEngine} can be found in {@link #onDetach()}.
   */
  void release() {
    this.host = null;
  ...
  /**
   * Returns the {@link FlutterEngine} that is owned by this delegate
   ...
   *   <li>Attaches the {@link FlutterEngine} to the surrounding {@code
   *       Activity}, if desired.
   ...
   * FlutterEngine}, and if so, the cached {@link
   * FlutterEngine} is retrieved.
   *
   * <p>Second, the {@code host} is given an opportunity to provide a {@link
   * FlutterEngine} via {@link Host#provideFlutterEngine(Context)}.
   *
   * <p>Third, the {@code host} is asked if it would like to use a cached {@link
   * FlutterEngineGroup} to create a new {@link FlutterEngine} by {@link
   * FlutterEngineGroup#createAndRunEngine}
   *
   * <p>If the {@code host} does not provide a {@link FlutterEngine},
   ...
   * OnPreDrawListener}, which will defer the current drawing pass
   ...
   *   <li>attaches a {@link FlutterEngine} to the new {@link
   *       FlutterView}
   ...
   *       lifecycle.
   *   <li>Detaches this delegate's {@link FlutterEngine} from this
   ...
   *
   * <ol>
   *   <li>Detaches this delegate's {@link FlutterEngine} from its
  ...
  /**
   * Invoke this from {@link Activity#onRequestPermissionsResult(int, String[], int[])}
  ...
  /* package */ interface Host
    ...
    /**
     * Returns the {@link Context} that backs the host {@link Activity} or {@code
     * Fragment}.
     */
    @NonNull
    Context getContext();
    ...
    /**
     * Returns the host {@link Activity} or the {@code Activity} that is currently
    ...
    /**
     * Returns the {@link Lifecycle} that backs the host {@link Activity} or {@code
     * Fragment}.
     */
    @NonNull
    ...
    /**
     * Returns the ID of a statically cached {@link FlutterEngine} to
    ...
    /**
     * Returns true if the {@link FlutterEngine} used in this delegate
     ...
     * {@link FlutterEngine}, and {@code false} in cases where a cached
     * {@link FlutterEngine} was provided.
     */
    boolean shouldDestroyEngineWithHost();

    /**
     * Callback called when the {@link FlutterEngine} has been attached
    ...
    /**
     * Returns the {@link FlutterEngine} that should be rendered to a
     * {@link FlutterView}.
     *
     * <p>If {@code null} is returned, a new {@link FlutterEngine} will
    ...
    /**
     * Hook for the host to configure the {@link FlutterEngine} as
     * desired.
     */
    ...
    /**
     * Returns true if the {@link FlutterEngine}'s plugin system should
     * be connected to the host {@link Activity}, allowing plugins to interact with it.
     */
