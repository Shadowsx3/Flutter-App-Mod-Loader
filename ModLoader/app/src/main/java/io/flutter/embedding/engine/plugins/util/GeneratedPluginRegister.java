...
public class GeneratedPluginRegister {
   ...
   * FlutterEngine}. When a {@link
   * FlutterEngine} is explicitly created, it automatically registers
   * plugins during its construction.
   *
   * <p>Since the {@link FlutterEngine} belongs to the Flutter engine
   * and the GeneratedPluginRegistrant class belongs to the app project, the {@link
   * FlutterEngine} cannot place a compile-time dependency on
   ...
   *
   * <ul>
   *   <li>If you manually construct {@link FlutterEngine}s, construct
   *       the {@link FlutterEngine} with the {@code
   ...
   *       FlutterEngine} implicitly, override the {@code
