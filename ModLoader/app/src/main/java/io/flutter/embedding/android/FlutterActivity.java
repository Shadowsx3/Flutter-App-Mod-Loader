 ...
 * FlutterEngine} instead of creating a new one. Use {@link
 * #withCachedEngine(String)} to build a {@code FlutterActivity} {@code Intent} that is configured
 * to use an existing, cached {@link FlutterEngine}. {@link
 * io.flutter.embedding.engine.FlutterEngineCache} is the cache that is used to obtain a given
 * cached {@link FlutterEngine}. You must create and put a {@link
 * FlutterEngine} into the {@link
 ...
 *
 * <p>When using a cached {@link FlutterEngine}, that {@link
 * FlutterEngine} should already be executing Dart code, which means
...
public class FlutterActivity extends Activity
   ...
   * FlutterEngine} using the desired Dart entrypoint, initial route,
   * etc.
   *
   ...
   * FlutterEngine} that is cached in {@link
   ...
   * {@link FlutterEngine} that is cached in {@link
   * io.flutter.embedding.engine.FlutterEngineCache}.
   */
  public static class CachedEngineIntentBuilder {
    ...
    /**
     * Whether the cached {@link FlutterEngine} should be destroyed and
   ...
   * FlutterEngine} and its subcomponents.
   *
   ...
   * FlutterEngine}.
   *
   * <p>This hook is where a cached {@link FlutterEngine} should be
   ...
   * are attached to the {@link FlutterEngine}. If {@code
   * shouldAttachEngineToActivity} is true, then this {@code FlutterActivity} will connect its
   * {@link FlutterEngine} to itself, along with any plugins that are
   * registered with that {@link FlutterEngine}. This allows plugins to
   ...
   * FlutterEngine} from being attaching to a {@code FlutterActivity} -
   ...
   * {@link FlutterEngine} to outlive this {@code FlutterActivity} so
   * that it can be used later in a different {@code Activity}. To accomplish this, the {@link
   * FlutterEngine} may need to be disconnected from this {@code
   * FlutterActivity} at an unusual time, preventing this {@code FlutterActivity} from correctly
   * managing the relationship between the {@link FlutterEngine} and
   * itself.
   */
  @Override
